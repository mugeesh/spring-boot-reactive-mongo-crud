...
public class EmployeeServiceTest {
    ...
    @Test
    public void shouldSalarybyRange() {

        Flux<Employee> flux=Flux.just(employee);

        when(repository.findEmployeeBySalaryBetween(1000, 2000)).thenReturn(flux);

        Flux<EmployeeDto> empdtoMono = service.findEmployeeBySalaryBetween(1000, 2000);
